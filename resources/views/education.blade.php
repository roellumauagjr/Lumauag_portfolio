    ...
    <section class="py-5">
        <div class="container px-4">
            <div class="row mb-5 fade-in-up">
                <div class="col-md-8">
                    <h1 class="display-4 fw-bold mb-3">{{ $settings['edu_page_title'] ?? 'Educational' }} <span class="text-orange">{{ $settings['edu_page_accent'] ?? 'Background' }}</span></h1>
                    <p class="lead text-secondary">{{ $settings['edu_page_subtitle'] ?? 'My academic journey and professional certifications.' }}</p>
                </div>
            </div>
            ...
            <div class="row fade-in-up delay-1 justify-content-center">
                <div class="col-lg-10">
                    <h2 class="h3 fw-bold text-white mb-4"><i class="bi bi-mortarboard text-orange me-2"></i> Academic
                        <span class="text-orange">History</span></h2>
                    ...
                    <h2 class="h3 fw-bold text-white mb-4 mt-5"><i class="bi bi-patch-check text-orange me-2"></i> {{ $settings['edu_certifications_title'] ?? 'Certifications & Awards' }}</h2>
                    <div class="row g-4">
                        @forelse($certifications as $cert)
                            <div class="col-md-6">
                                <div class="glass-card h-100 p-4 border border-secondary border-opacity-10 position-relative overflow-hidden">
